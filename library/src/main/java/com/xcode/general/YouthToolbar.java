...
public class YouthToolbar extends Toolbar {

    private TextView mTitleTextView;  //title textView
    private CharSequence mTitleText;    //title text

    public YouthToolbar(Context context) {
        super(context);
    }

    public YouthToolbar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public YouthToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
